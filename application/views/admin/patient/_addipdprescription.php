                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea style="height:150px" name="header_note" class="form-control" id="compose-textareanewadd"></textarea>
                                </div> 
                                <hr/>
                            </div>
                    ...
                    <option value="<?php echo set_value('medicine_category_id'); ?>"><?php echo $this->lang->line('select') ?>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea style="height:150px" rows="1" name="footer_note" class="form-control" id="compose-textareasadd"></textarea>
                                </div> 
                            </div>
                        </div>
                    </div> 
